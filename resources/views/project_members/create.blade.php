        ...
        <form action="{{ route('project_members.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name"
                    class="mt-1 p-2 w-full border rounded-lg focus:ring focus:ring-blue-300" value="{{ old('name') }}"
                    required>
                @error('name')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="role" id="role"
                    class="mt-1 p-2 w-full border rounded-lg focus:ring focus:ring-blue-300" value="{{ old('role') }}"
                    required>
                @error('role')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-4">
                ...
                <input type="text" name="group" id="group"
                    class="mt-1 p-2 w-full border rounded-lg focus:ring focus:ring-blue-300" value="{{ old('group') }}"
                    required>
                @error('group')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" id="email"
                    class="mt-1 p-2 w-full border rounded-lg focus:ring focus:ring-blue-300" value="{{ old('email') }}"
                    required>
                @error('email')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
