<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto bg-white p-6 rounded-lg shadow-lg mt-10">
        ...
        <div class="mb-4 flex justify-end">
            <a href="{{ route('clients.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-200">
                + Add Client
            </a>
        </div>
                    ...
                    @forelse($clients as $client)
                        <tr class="border-t">
                            ...
                            <td class="px-4 py-2 flex space-x-2 justify-center">
                                <a href="{{ route('clients.edit', $client->id) }}" class="bg-yellow-500 text-white px-3 py-1 rounded-lg hover:bg-yellow-600 transition">
                                    Edit
                                </a>
