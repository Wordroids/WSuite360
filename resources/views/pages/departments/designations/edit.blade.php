<x-app-layout>
    <div class="max-w-7xl mx-auto bg-white p-6 rounded-lg shadow-lg mt-10">
        ...
        <form action="{{ route('departments.designations.update', [$department, $designation]) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="space-y-4">
                <div>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="mt-1 p-2 w-full border rounded-lg focus:ring focus:ring-blue-300">{{ old('description', $designation->description) }}</textarea>
                </div>
            </div>
