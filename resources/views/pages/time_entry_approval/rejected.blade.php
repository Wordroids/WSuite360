<x-app-layout>
    <div class="container mx-auto p-6">
        <h1 class="text-2xl font-bold mb-4 text-gray-800">Rejected Entries</h1>

        <!-- Tab Navigation -->
        <div class="mb-4 flex border-b">
            <button onclick="window.location.href='{{ route('pages.time_entry_approval.index') }}'"
                class="px-4 py-2 text-sm font-medium text-gray-600 hover:text-indigo-700">All</button>
            ...
            <button onclick="window.location.href='{{ route('pages.time_entry_approval.rejected') }}'"
                class="px-4 py-2 text-sm font-medium text-indigo-700 border-b-2 border-indigo-700">Rejected</button>
        </div>
            ...
            <table class="min-w-full table-auto border-collapse border border-gray-200 text-sm text-gray-800">
                ...
                <tbody>
                    <tr class="bg-white hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 border text-red-500 font-semibold">Rejected</td>
                        <td class="px-6 py-4 border flex space-x-2">
                            ...
                            <button
                                class="px-3 py-1 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition">Pending</button>
                        </td>
                    </tr>
                    <tr class="bg-white hover:bg-gray-50">
