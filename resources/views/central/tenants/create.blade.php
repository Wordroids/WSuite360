...
<x-central-layout>
  ...
  <form action="{{route('tenants.store')}}" method="post" class="flex flex-col gap-4">
    ...
    <div>
      ...
      <div class="mt-2 flex">
        <input type="text" name="name" value="{{old('name', '')}}" id="name" class="block w-full grow rounded-md bg-white dark:bg-gray-600 px-3 py-1.5 text-base text-gray-900 dark:text-gray-200 placeholder:text-gray-400 sm:text-sm/6" placeholder="Exampleco, LLC">
      </div>
    ...
    <div>
      ...
      <div class="mt-2 flex">
        <input type="text" name="id" value="{{old('id', '')}}" id="id" class="block w-full grow rounded-md bg-white dark:bg-gray-600 px-3 py-1.5 text-base text-gray-900 dark:text-gray-200 placeholder:text-gray-400 sm:text-sm/6" placeholder="exampleco">
      </div>
