<x-app-layout>
    <div class="container mx-auto p-6">
        <h1 class="text-2xl font-bold mb-4 text-gray-800">Approved Entries</h1>
        ...
        <div class="mb-4 flex border-b">
            ...
            <button onclick="window.location.href='{{ route('pages.time_entry_approval.approved') }}'"
                class="px-4 py-2 text-sm font-medium text-indigo-700 border-b-2 border-indigo-700">Approved</button>
