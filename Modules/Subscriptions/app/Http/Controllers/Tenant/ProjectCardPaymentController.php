...
use Modules\Projects\Models\ProjectSubscription;
...
class ProjectCardPaymentController extends Controller
{
    ...
    public function selectCard()
    {
        $clients = Client::all();
        $projects = collect();
        return view('subscriptions::pages.payments.cardCharge', compact('clients', 'projects'));
    }
    ...
    public function confirm(Request $request)
    {
        ...
        return view('subscriptions::pages.payments.cardConfirm', [
            'client' => $client,
            'project' => $project,
