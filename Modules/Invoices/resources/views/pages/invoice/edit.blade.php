                                ...
                                <tr class="border-t">
                                    ...
                                    <td class="px-2 py-2">
                                        <input type="text" :name="`products[${index}][description]`"
                                            x-model="products[index].description" placeholder="Description"
                                            class="w-full border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring focus:ring-indigo-300">
                                    </td>
                                    ...
                                    <td class="px-2 py-2">
                                        <input type="number" min="0" step="1"
                                            :name="`products[${index}][quantity]`" x-model.number="products[index].quantity"
                                    ...
                                    <td class="px-2 py-2">
                                        <input type="number" step="0.01" min="0"
                                            :name="`products[${index}][price]`" x-model.number="products[index].price"
